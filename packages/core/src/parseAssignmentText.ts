...
const TYPE_KEYWORDS: { type: AssignmentType; patterns: RegExp[] }[] = [
  {
    type: 'quiz',
    patterns: [/quiz\b/i]
  },
...
export function parseAssignmentText(input: string): ParsedAssignmentDraft {
