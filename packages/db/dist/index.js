...
let dbInstance = null;
let dbFilePath = null;
function formatCorruptSuffix(now = new Date()) {
...
function backupCorruptDbFiles(dbPath, suffix) {
...
function openDatabaseWithPragmas(file) {
...
function applyMigrations() {
    ...
    try {
        runWrite('migration:createMigrationsTable', () => db.exec(`CREATE TABLE IF NOT EXISTS migrations (
        id TEXT PRIMARY KEY,
        applied_at TEXT NOT NULL
      );`));
